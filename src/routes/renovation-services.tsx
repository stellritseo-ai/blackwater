...
export const Route = createFileRoute("/renovation-services")({
  head: () => ({
    meta: [
      { title: "Home Renovation Services South Mississippi | Blackwater USA LLC" },
      { name: "description", content: "Whole home & commercial renovation in Moss Point, Pascagoula & Gulf Coast MS. 43 years experience in structural upgrades, historic restorations & 24/7 estimates." },
      { property: "og:title", content: "Home Renovation Services South Mississippi | Blackwater USA LLC" },
      { property: "og:description", content: "Complete residential and commercial renovation services across South Mississippi & Southwest Alabama by Blackwater USA LLC." },
...
function RenovationServicesPage() {
  ...
  const breadcrumbsSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://blackwaterusallc.com/renovation-services"
      }
    ]
  };
  ...
  const serviceSchema = {
    ...
    "description": "Full-scale home renovation, structural modernization, historical property restoration, commercial refits, and disaster recovery across South Mississippi and Southwest Alabama."
  };
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col w-full">
      ...
      <section className="relative py-16 lg:py-24 overflow-hidden w-full isolate">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={sRenovation} 
            alt="Home Renovation Services South Mississippi - Blackwater USA LLC" 
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs text-white/60">
            ...
            <span>/</span>
            <span className="text-gold font-medium">Renovation Services</span>
          </nav>

          <div className="max-w-3xl">
            <Reveal variant="reveal" className="flex items-center gap-2 mb-4">
              <span className="h-px w-8 bg-gold" />
              <span className="text-gold uppercase tracking-[0.2em] text-xs font-bold font-sans">Full Renovation</span>
            </Reveal>
            <Reveal variant="reveal" className="stagger-1">
              <h1 className="text-[32px] sm:text-[44px] lg:text-[54px] font-bold text-white leading-tight tracking-[-0.03em] font-display">
                Home Renovation Services in <span className="text-gradient-gold">South Mississippi</span>
              </h1>
            </Reveal>
            <Reveal variant="reveal" className="stagger-2">
              <p className="mt-5 text-base sm:text-lg text-white/80 leading-relaxed max-w-2xl font-medium">
                Comprehensive residential and commercial renovation services in Moss Point, Pascagoula, Biloxi, and across the Gulf Coast with 43 years of proven craftsmanship.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <section className="py-12 bg-secondary/40 border-t border-border">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 text-center">
          <h3 className="text-xs font-bold uppercase tracking-wider text-navy mb-4">Renovation Service Areas:</h3>
