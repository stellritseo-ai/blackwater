...
export const Route = createFileRoute("/residential-services")({
  head: () => ({
    meta: [
      { title: "Residential Contractor Moss Point MS | Blackwater USA LLC" },
      { name: "description", content: "Residential contractor serving Moss Point, Pascagoula & Gulf Coast MS. 43 years experience in home additions, remodeling, carpentry, roofing repairs & 24/7 estimates." },
      { property: "og:title", content: "Residential Contractor Moss Point MS | Blackwater USA LLC" },
      { property: "og:description", content: "Complete residential construction, home remodeling, room additions, and custom carpentry across South Mississippi & Southwest Alabama." },
...
function ResidentialServicesPage() {
  ...
  const breadcrumbsSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://blackwaterusallc.com/residential-services"
      }
    ]
  };
  ...
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Residential Contractor",
    "provider": {
    ...
    "description": "Comprehensive residential general contracting, home additions, room remodeling, structural carpentry, roofing repairs, and maintenance across South Mississippi."
  };
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col w-full">
      ...
      <section className="relative py-16 lg:py-24 overflow-hidden w-full isolate">
        <div className="absolute inset-0 z-0">
          <img 
            src={sResidential} 
            alt="Residential Contractor in Moss Point MS - Blackwater USA LLC" 
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs text-white/60">
            ...
            <span>/</span>
            <span className="text-gold font-medium">Residential Services</span>
          </nav>

          <div className="max-w-3xl">
            <Reveal variant="reveal" className="flex items-center gap-2 mb-4">
              <span className="h-px w-8 bg-gold" />
              <span className="text-gold uppercase tracking-[0.2em] text-xs font-bold font-sans">Residential Contracting</span>
            </Reveal>
            <Reveal variant="reveal" className="stagger-1">
              <h1 className="text-[32px] sm:text-[44px] lg:text-[54px] font-bold text-white leading-tight tracking-[-0.03em] font-display">
                Residential Contractor in <span className="text-gradient-gold">Moss Point, MS</span>
              </h1>
            </Reveal>
            <Reveal variant="reveal" className="stagger-2">
              <p className="mt-5 text-base sm:text-lg text-white/80 leading-relaxed max-w-2xl font-medium">
                Complete home remodeling, room additions, structural repairs, and exterior upgrades in Moss Point, Pascagoula, and the Mississippi Gulf Coast.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <section className="py-12 bg-secondary/40 border-t border-border">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 text-center">
          <h3 className="text-xs font-bold uppercase tracking-wider text-navy mb-4">Residential Service Areas:</h3>
